...
if __name__ == "__main__":
    ...
    for index, candidato in enumerate(lista_pruebas):
        ...
        print("Porcentaje de diferenca de conflicto modificado:", (1 - (conf_fbcost_fb/conf_vz))*100 if conf_fbcost_fb > 0 else 0, "%")
        
        diferencia_porcentaje = (1 - (conf_fbcost_fb/conf_vz))*100 if conf_fbcost_fb > 0 else 0
